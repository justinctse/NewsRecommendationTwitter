#Easy Version of News Recommendation System
#Does not require the full data set
#This version of the recommendation GUI loads in the bowModel as a list
rm(list=ls())
library(tm)
library(qdap)
library(nytimes)
...
#Load the Bag of Words Model
bowModel <- readRDS("bowModel_Apr9_2018.Rdata")
